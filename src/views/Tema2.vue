  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg1.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-7(data-aos="fade-left")
          .p-4
            img.mb-4.img-t.d-none.d-lg-block(src='@/assets/curso/tema2/2.svg')
        ...
        SlyderF(columnas="col-md-6 col-xl-4")
          .tarjeta.tarjeta--slyder.b1.p-lg-5.p-4
            .row.justify-content-center.align-items-center.mb-4.mt-3
              .col-12
                img.img-a.img-t(src='@/assets/curso/tema2/3.svg')
            h4.text-center.mb-4 Escucha activa
            p.mb-4.text-center Prestar atención al mensaje, demostrando interés y comprensión.
          .tarjeta.tarjeta--slyder.b1.p-lg-5.p-4
            .row.justify-content-center.align-items-center.mb-4.mt-3
              .col-12
                img.img-a.img-t(src='@/assets/curso/tema2/4.svg')
            h4.text-center.mb-4 Mensaje en primera persona
            p.mb-4.text-center Expresar opiniones o sentimientos utilizando frases como “yo considero” o “yo observo”.
          .tarjeta.tarjeta--slyder.b1.p-lg-5.p-4
            .row.justify-content-center.align-items-center.mb-4.mt-3
              .col-12
                img.img-a.img-t(src='@/assets/curso/tema2/5.svg')
            h4.text-center.mb-4 Comunicación clara y directa
            p.mb-4.text-center Transmitir la información de manera sencilla, precisa y comprensible.
          .tarjeta.tarjeta--slyder.b1.p-lg-5.p-4
            .row.justify-content-center.align-items-center.mb-4.mt-3
              .col-12
                img.img-a.img-t(src='@/assets/curso/tema2/6.svg')
            h4.text-center.mb-4 Empatía
            p.mb-4.text-center Comprender y reconocer las emociones, necesidades y perspectivas de otras personas.
          .tarjeta.tarjeta--slyder.b1.p-lg-5.p-4
            .row.justify-content-center.align-items-center.mb-4.mt-3
              .col-12
      ...
      .col-lg-7
        .row.justify-content-center.mb-3
          ...
          .col-lg-10
            ...
            p.mb-0 En turismo de aventura, algunas herramientas de la PNL permiten: mejorar procesos comunicativos, fortalecer el liderazgo, generar confianza, manejar emociones y facilitar el trabajo en equipo. 
        p.mb-2 La PNL reconoce que las personas interpretan la realidad de manera diferente según sus experiencias, emociones y formas de percepción.
        p.mb-0 Por esta razón, quienes lideran actividades turísticas deben adaptar su comunicación a las características del grupo y utilizar mensajes positivos y motivadores. 
    ...
    .row.justify-content-center.align-items-center.mb-0(data-aos="fade-left")
      .col-lg-12
        .titulo-sexto.mb-4
          h5 Figura 3.
          | Manejo de la comunicación en turismo de aventura
        .bg3.p-4.p-lg-5
          img.img-t.img-a(src='@/assets/curso/tema2/11.svg', alt='Resalta el manejo de la comunicación en turismo de aventura, teniendo en cuenta los elementos antes de la actividad, durante la actividad y después de la actividad.')
