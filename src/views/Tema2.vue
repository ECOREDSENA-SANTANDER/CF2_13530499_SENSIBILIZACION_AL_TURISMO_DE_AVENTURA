  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg1.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-7(data-aos="fade-left")
          .p-4
            img.mb-4.img-t.d-none.d-lg-block(src='@/assets/curso/tema2/2.svg', alt='')
      ...
      .col-lg-7
        .row.justify-content-center.mb-3
          ...
          .col-lg-10
            ...
            p.mb-0 En turismo de aventura, algunas herramientas de la PNL permiten: mejorar procesos comunicativos, fortalecer liderazgo, generar confianza, manejar emociones y facilitar trabajo en equipo. 
    ...
    .row.justify-content-center.align-items-center.mb-0(data-aos="fade-left")
      .col-lg-12
        ...
        .bg3.p-4.p-lg-5
          img.img-t.img-a(src='@/assets/curso/tema2/11.svg',alt='Resalta el manejo de la comunicación en Turismo de Aventura, teniendo en cuenta los elementos a tener en cuenta antes de la actividad, durante la actividad y después de la actividad.')
